...
This interactive financial dashboard analyzes a comprehensive loan portfolio of 38,600 applications worth $435.8M, providing real-time insights into loan performance, risk assessment, and portfolio health. The system features advanced data visualizations including geographic distribution maps, temporal trend analysis, and risk categorization with an impressive 86.2% good loan ratio. Built to support data-driven decision making in banking operations, the dashboard delivers actionable insights for loan officers, risk managers, and executive leadership through intuitive charts, KPI tracking, and comprehensive filtering capabilities.

**Data Structure**

<img width="491" height="414" alt="1" src="https://github.com/user-attachments/assets/1df68931-debf-40b6-90cd-b59bc14d5b3c" />
...
**Detailed Portfolio Analysis (NB:Deeper Insights can be derived from the dashboards using interactive slicers,here is just an example of 1 slicer applied**
...
**Relationship Banking:** Create loyalty programs for repeat customers with good payment history
